...
userRouter.post("/createV2", verifyToken, userController.createUserV2); // /api/user/create
...
userRouter.get("/getUserByNumber", verifyToken, userController.getUserByNumber); // /api/user/get
...
userRouter.post('/updateDeviceToken', verifyToken, userController.updateAndAddDeviceToken);
...
userRouter.get("/getAllLocalUsers/:userId", verifyToken, userController.getAllLocalUsers);
